...
local function SetCVarBool(name, enabled)
    ...
    if C_CVar and C_CVar.SetCVar then
        pcall(C_CVar.SetCVar, name, enabled and "1" or "0")
        return
    end
    if SetCVar then pcall(SetCVar, name, enabled and "1" or "0") end
end
...
function M:Apply()
    ...
    SetCVarBool("floatingCombatTextCombatDamage_v2", cfg.showCombatDamage == true)
    SetCVarBool("floatingCombatTextCombatHealing_v2", cfg.showCombatHealing == true)
